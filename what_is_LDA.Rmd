...
```{r, Dirichlet2, fig.height=4, fig.width=12}
set.seed(442288)
alpha <- 0.1
documents <- 3
topics <- 6
...
```{r, Dirichlet, fig.height=4, fig.width=9, fig.align="center"}
...
```{r, asym, warning=FALSE, fig.width=12, fig.height=4}
set.seed(224488)
alpha <- c(2, 0.1)
documents <- 3
topics <- 6
...
```{r,asym2, fig.height=4, fig.width=12, warning=FALSE}
plot_dirichlet <- function(alpha){
set.seed(1234)
documents <- 3
topics <- 6
